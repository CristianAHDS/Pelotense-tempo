...
const DayOne = () => {
  ...
  const initialDate = localStorage.getItem('day1_date')
    ? new Date(localStorage.getItem('day1_date'))
    : new Date();
  ...
  const handleDate = (date) => {
    ...
    localStorage.setItem('day1_title', formatted);
    localStorage.setItem('day1_date', date.toISOString());
  };
